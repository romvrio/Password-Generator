...
function generate() {
  var passwordType = window.prompt("How many characters would you like?");

  if (passwordType < 8 || passwordType > 128) {
    //inform user that password can not exceed these lengths
    window.alert("Password must be at least 8-128 charachters long");
    passwordType = window.prompt("How many characters would like?");
